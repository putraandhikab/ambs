...
<html lang="en">
  <head>
    ...
    <!-- My CSS -->
    <link rel="stylesheet" href="<?= base_url() ?>assets/css/formnote.css">
  ...
  <body>
    ...
    <div class="container-form">
        <form action="<?= base_url('Mynotes/tambah') ?>" method="post">
            <div class="title-category">
                <div class="form-group title row">
                    <label for="inputTitle" class="col-sm-2 col-form-label">Title</label>
                    <?= form_error('judul', '<small class="text-danger pl-3">', '</small>'); ?>
                    <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputTitle" placeholder="Title" name="judul">
            ...
            <div class="uploadnote">
                <label for="uploadnotebtn">Upload Note</label>
                <input type="file" id="uploadnotebtn">
            </div>
            <div class="formbtn">
                <a href="mynotes.php" class="btn btn-primary">Cancel</a>
